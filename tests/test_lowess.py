...
def test_lowess():
    ...
    f_real = np.sin(x0)
    # This doesn't work, because the algorithm isn't that accurate. Need to
    # think about something that actually works... 
    npt.assert_array_almost_equal(f_hat, f_real)
